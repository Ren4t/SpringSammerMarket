...
public class AppLoggingAspect {
    ...
    @Around("execution(public * ru.geekbrains.summer.market.services.OrderService.*(..))")
    public Object methodProfilingOrderService(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        statistic.buildStatistic("OrderService",duration);
        return out;
    }
    @Around("execution(public * ru.geekbrains.summer.market.services.ProductService.*(..))")
    public Object methodProfilingProductService(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        System.out.println((MethodSignature) proceedingJoinPoint.getSignature() + " duration: " + duration);
        System.out.println("end profiling");
        statistic.buildStatistic("ProductService",duration);
        return out;
    }
